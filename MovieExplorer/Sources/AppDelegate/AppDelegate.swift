...
extension AppDelegate {
  ...
  func setNavigationBarAppearance() {
    ...
    appearance.titleTextAttributes = [NSAttributedString.Key.foregroundColor: navTintColor, NSAttributedString.Key.font: UIFont.init(name: "Rockout", size: 32.0) ?? UIFont.boldSystemFont(ofSize: 17)]
